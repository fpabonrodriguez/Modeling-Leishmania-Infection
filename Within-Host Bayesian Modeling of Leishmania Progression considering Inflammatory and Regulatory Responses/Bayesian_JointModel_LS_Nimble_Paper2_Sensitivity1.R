...
BayesianModel <- nimbleCode({
  ...
  sigma2.betaP ~ dunif(0,100)
  sigma2.betaA ~ dunif(0,100)
  sigma2.betaD2 ~ dunif(0,100)
  sigma2.betaD3 ~ dunif(0,100)
  sigma2.betaI1 ~ dunif(0,100)
  sigma2.betaI2 ~ dunif(0,100)
  sigma2.betaI3 ~ dunif(0,100)
  sigma2.betaR1 ~ dunif(0,100)
  sigma2.betaR2 ~ dunif(0,100)
  sigma2.betaR3 ~ dunif(0,100)
